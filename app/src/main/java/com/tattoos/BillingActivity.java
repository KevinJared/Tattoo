...
public class BillingActivity extends AppCompatActivity implements PurchasesUpdatedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Tattoo tattoo = (Tattoo) getIntent().getSerializableExtra("tattoo");
        ImageView tattooImage = findViewById(R.id.tattooImage);
        TextView tattooTitle = findViewById(R.id.tattooTitle);
        tattooImage.setImageResource(tattoo.getImage());
        tattooTitle.setText(getString(tattoo.getDescription()));
